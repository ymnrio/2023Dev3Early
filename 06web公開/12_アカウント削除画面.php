  ...
  <div class="row">
    ...
    <div class="col-md-6 col-lg-6">
      ...
      <div class="text-line">
       ...
       <h6><font color="red">アカウントを削除してよろしいですか？</font></h6>
       <div class="row magin40_yamanisi">
            ...
            <div class="col-md-6" id="btn_nh">
              <button value="削除" name="delate" onclick="location.href='account_delete.php'" class="btn container-fluid color_white_yamani" style="background-color:#FBA8B8;width: 90%;margin-right: 30px;">削除
            </button>
            </div>
          </div>
    </div>
