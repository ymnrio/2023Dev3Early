...
echo                    '<div style="font-size: 20px;" onclick="location.href='."'08_投稿詳細画面.php'".'" value="投稿">';
echo                      'ギター楽しい<br>'.
                    '</div>'.
                    '<div class="row">'.
                      '<div class="col-md-9 col-lg-9 start_0_ys"></div>'.
                      '<div class="col-md-1 col-lg-1 start_0_ys">';
echo                        '<input type="checkbox" id="like1">'.
...
echo            '</div>　';
echo            '<div class="row">';
echo              '<div class="col-md-9 col-lg-9 start_0_ys"></div>';
echo              '<div class="col-md-1 col-lg-1 start_0_ys">';
echo                '<input type="checkbox" id="like1">';
