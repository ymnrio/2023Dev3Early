...
echo             '<form action="08_投稿詳細画面.php" method="post">'.
                  ...
                  echo nl2br($row['post_contents']).
                    ...
                    if($type == '1'){ //画像
                      ...
                      $base64_image = base64_encode($image_data);
                      echo '<video style="  max-height:300px;  max-width:600px;"  src="data:video/mp4;base64,'.$base64_image.'"controls></video>';
                    }
...
echo                '<button type="hidden" name="like" value="2,'.$row['post_id'].',7" style="width:90px;background-color:white;border:none;">'.//最初からいいねしてるかの判別
                ...
                $pdo = new PDO('mysql:host=localhost;dbname=yamatter_2;charset=utf8','root','root');//←これ追加したら表示した
